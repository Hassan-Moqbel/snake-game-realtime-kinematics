...
* **Time Complexity per Tick:** $\mathcal{O}(L)$ *(linear shift of tail coordinates and collision scan)*
* **Auxiliary Space Complexity:** $\mathcal{O}(L_{\max})$ *(static contiguous array allocation for coordinate history)*
